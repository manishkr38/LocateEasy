...
<head>
  <title>List of people requested blood</title>
...
<body>
  <div id="main">
	...
	<div id="right_content">
	  ...
	  <div id="content">
         <h1>Search results for urgent blood requirement</h1>
		  <div id="list">
...
s.executeQuery("select * from blodrequest");
...
while (rs.next()) {  
	...
	<div id="img">
	 <div class="content_image">
		    <img src="../../images/bloodreq.jpg" alt="image1" />
		    </div>
	      </div>
...
<p> Patient Name:  <%=rs.getString("name") %> &nbsp;&nbsp; |&nbsp;&nbsp;  Age:<%=rs.getString("age") %></p>
 
 <p> Unit needed:<%=rs.getString("unitneed") %>&nbsp; |&nbsp; Needed till:<%=rs.getString("neededtill") %> </p>
 <p> Hospital Name:<%=rs.getString("hospital") %> </p>
 <div class="icon_image">
 ...
 <div id="down">
      <ul id="hig">
        ...
        <li><a href="requestEditLogin.html">Edit</a></li>
        <li><a href="requestEditLogin.html">Delete</a></li>
