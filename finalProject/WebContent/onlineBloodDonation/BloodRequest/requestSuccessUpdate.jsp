...
<head>
  <title>Data Successfully updated</title>
	...
	<div id="right_content">
	  ...
	  <div id="content">
        ...
        <div id="form_wrapper" class="form_wrapper">
		 ...
		 <h2> your data is successfully updated on this website !</h2>
		
				
					 <a href="displayRequestProfile.html"><h4>check your profile</h4></a>
