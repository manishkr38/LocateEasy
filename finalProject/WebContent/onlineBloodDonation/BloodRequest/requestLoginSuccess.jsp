...
<head>
  <title>welcome! your login successfull</title>
	  ...
	  <div id="content">
        ...
        <div id="form_wrapper" class="form_wrapper">
            ...
            <% 
              ...
              {   %>
            <h2>  You are Not logged in !  <h2></h2> <br/>
                  <a href="requestEditLogin.html"><h4>please login</h4></a>

              <%  }

                 else {
              %>
                  <h2> Welcome <%=session.getAttribute("userid") %>,&nbsp;You are Successfully Logged in !</h2> 

                 
					<a href="requestUpdate.jsp">	<h3>Edit your Profile</h3> </a>
						
						<a href='DeleteProfile.html'><h4>Delete Your Profile</h4></a>
						
		        		<a href='requestLogout.jsp'><h4>Logout</h4></a>	
