...
<body>
  <div id="main">
	...
	<div id="right_content">
	  ...
	  <div id="content">
         <h1>Search results for OnCall services</h1>
		  <div id="list">
...
String yes=request.getParameter("param"); 

Statement s = conn.createStatement();

s.executeQuery("select * from doctr where oncall='"+yes+"'");
