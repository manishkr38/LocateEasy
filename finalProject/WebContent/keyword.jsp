...
//String cat = request.getParameter("speciality");
//String loc=request.getParameter("state");
//String dis=request.getParameter("disease");
//String doct=request.getParameter("doctor_name");
...
//s.executeQuery("select * from doctr where category= '"+cat+"' or state= '"+loc+"' or disease= '"+dis+"' or name= '"+doct+"' or clinic= '"+hosp+"' or state= '"+loc+"' or disease like '%"+srch+"%' or name like '%"+srch+"%' or clinic like '%"+srch+"%' or category like '%"+srch+"%' or qualification like '%"+srch+"%' or experience like '%"+srch+"%' or address like '%"+srch+"%' or state like '%"+srch+"%' or checkup like '%"+srch+"%' or timing like '%"+srch+"%' ");


s.executeQuery("select * from doctr where disease like '%"+srch+"%' or name like '%"+srch+"%' or clinic like '%"+srch+"%' or category like '%"+srch+"%' or qualification like '%"+srch+"%' or experience like '%"+srch+"%' or address like '%"+srch+"%' or state like '%"+srch+"%' or checkup like '%"+srch+"%' or timing like '%"+srch+"%' or type like '%"+srch+"%' ");
...
<b><p id="head"> <%=rs.getString("clinic") %> </p></b>
    </div>
...
<p> Doctor Name: <b> <%=rs.getString("name") %></b>&nbsp;( <%=rs.getString("qualification") %>)
 ...
 <p><a href=""><%=rs.getString("contact") %></a></p>
 </div>
 ...
 <div id="down">
      <ul id="hig">
        ...
        <li><a href="AddDoctor/login.html">Edit</a></li>
