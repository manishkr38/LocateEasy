...
<head>
  <title><%=request.getParameter("param") %>&nbsp;Hospitals/Doctors</title>
...
<body>
  <div id="main">
	...
	<div id="right_content">
	  ...
	  <div id="content">
         <h1>Search results for <%=request.getParameter("param")%></h1>
		  <div id="list">
...
String typ=request.getParameter("param"); 

Statement s = conn.createStatement();

s.executeQuery("select * from doctr where type='"+typ+"'");
//s.executeQuery("select * from doctr where category='"+url+"'");
