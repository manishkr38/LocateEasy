...
int i=s.executeUpdate("update doctr set clinic='"+clinic+"',name='"+name+"',category='"+special+"',qualification='"+qualify+"',disease='"+disease+"',experience='"+experience+"',checkup='"+fees+"',timing='"+timing+"',address='"+address+"',state='"+state+"',contact='"+mobile+"',type='"+type+"',landline='"+landline+"',ambulance='"+ambulance+"',oncall='"+oncall+"',email='"+email+"' where username='"+username+"' ");
